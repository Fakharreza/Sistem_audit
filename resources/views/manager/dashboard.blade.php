        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-xl border border-gray-100 mb-8">
                <div class="p-6 bg-white border-b border-gray-200">
                    <h3 class="text-lg font-bold text-gray-900 mb-1">Peta Kapabilitas COBIT 2019</h3>
                    <p class="text-sm text-gray-500 mb-6">Visualisasi rata-rata tingkat kapabilitas (Level 0-5) perusahaan saat ini.</p>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="5" class="px-6 py-12 text-center text-gray-500">
                                            ...
                                            <p class="text-sm mt-1">Belum ada audit yang diselesaikan oleh tim Auditor.</p>
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            new Chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [{
                        label: 'Rata-rata Kapabilitas (Skala 5)',
                ...
                options: {
                    ...
                    scales: {
                        r: {
                            ...
                            suggestedMin: 0,
                            suggestedMax: 5, // Kunci maksimal di Level 5
                            ticks: {
                                stepSize: 1,
