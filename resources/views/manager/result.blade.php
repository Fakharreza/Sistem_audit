        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-xl border border-gray-200">
                        ...
                        @foreach($results as $index => $row)
                            <tr class="border-b {{ $index === 0 ? 'bg-yellow-50 hover:bg-yellow-100' : 'hover:bg-gray-50' }}">
                                ...
                                <td class="px-6 py-4 text-center">
                                    @if($index === 0)
                                        <span class="inline-flex items-center justify-center w-10 h-10 rounded-full bg-yellow-400 text-yellow-900 font-black text-lg shadow-sm">
                                            1
                                        </span>
                                    @elseif($index === 1)
                ...
                <div class="p-6 bg-gray-50 border-t border-gray-200 flex justify-end">
                    <a href="{{ route('manager.dashboard') }}" class="px-6 py-2 bg-white border border-gray-300 rounded text-sm font-bold text-gray-700 hover:bg-gray-100">Selesai & Kembali</a>
                </div>
            </div>
